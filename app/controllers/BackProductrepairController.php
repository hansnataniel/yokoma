...
class BackProductrepairController extends BaseController {
	...
	public function getIndex($id)
	{
        ...
        return View::make('back.product_repair.index', $data);
	}
	...
	public function getCreate()
	{
		...
		{
			$productrepair = Productrepair::first();
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/index/' . $productrepair->branch_id)->with('error-message', "Sorry you don't have any priviledge to access this page.");
		}
        ...
        return View::make('back.product_repair.create', $data);
	}
	...
	public function getAjaxBranch($branch_id)
	{
		...
		return View::make('back.product_repair.ajax_branch', $data);
	}
	...
	public function getAjaxProduct($branch_id, $product_id)
	{
		...
		return View::make('back.product_repair.ajax_product', $data);
	}
	...
	public function getAjaxBlurItem($branch_id)
	{
		...
		return View::make('back.product_repair.ajax_blur_item', $data);
	}
	...
	public function postAddItem()
	{
		...
		return View::make('back.product_repair.ajax_items', $data);
	}
	...
	public function getAjaxBlurUpdateItem($item_id, $branch_id)
	{
		...
		return View::make('back.product_repair.ajax_blur_update_item', $data);
	}
	...
	public function postCreate()
	{
		...
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/create')->withInput()->with('error-message', "Repair Item is not null.");
		}
		...
		if ($validator->passes())
		{
			DB::transaction(function() use ($setting){
				...
				$productrepair = new Productrepair;
				$productrepair->branch_id = htmlspecialchars(Input::get('branch_id'));
				$productrepair->customer_id = htmlspecialchars(Input::get('customer_id'));
				$productrepair->user_id = 0;
			...
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/index/' . $productrepair->branch_id)->with('success-message', "Repair Item <strong>$productrepair->no_invoice</strong> has been Created.");
		}
		else
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/create')->withInput()->withErrors($validator);
		}
	}
	...
	public function getView($id)
	{
		...
		if ($productrepair != null)
		{
	        ...
	        return View::make('back.product_repair.view', $data);
		}
		else
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/index/' . $productrepair->branch_id)->with('error-message', 'Can not find any Repair Item with ID ' . $id);
		}
	}
	...
	public function getEdit($id)
	{
		...
		if ($productrepair != null)
		{
	        ...
	        return View::make('back.product_repair.edit', $data);
		}
		else
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/index/' . $productrepair->branch_id)->with('error-message', 'Can not find any Repair Item with ID ' . $id);
	...
	public function putEdit($id)
	{
		...
		if(count(Cart::contents()) == 0)
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/edit/' . $id)->withInput()->with('error-message', "Repair Item is not null.");
		}
		...
		if ($validator->passes())
		{
			...
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/index/' . $productrepair->branch_id)->with('success-message', "Repair Item <strong>$productrepair->no_invoice</strong> has been Updated.");
		}
		else
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/product-repair/edit/' . $id)->withInput()->withErrors($validator);
		}
	}
}
