...
class BackSalesduedateController extends BaseController {
	...
	public function getIndex()
	{
		...
		$query->where('due_date', '<=', date('Y-m-d'))->where('status', '=', 'Waiting for Payment');
        ...
        return View::make('back.sale_duedate.index', $data);
	}
}
