...
class FrontCommissionreportController extends BaseController {
	...
	public function getIndex()
	{
		...
		$salesmans = Salesman::where('branch_id', '=', Auth::user()->get()->branch_id)->where('is_active', '=', 1)->get();
        ...
        return View::make('front.commission_report.index', $data);
	}
	...
	public function getReport()
	{
        ...
        return View::make('front.commission_report.report', $data);
