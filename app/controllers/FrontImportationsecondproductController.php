...
class FrontImportationsecondproductController extends BaseController {
	...
	public function getIndex()
	{
        ...
        return View::make('front.import_second_product.index', $data);
	}
	...
	public function getCreate()
	{
        ...
        return View::make('front.import_second_product.create', $data);
	}
	...
	public function getAjaxProduct($branch_id, $product_id)
	{
		...
		return View::make('front.import_second_product.ajax_product', $data);
	}
	...
	public function getAjaxBlurItem($branch_id)
	{
		...
		return View::make('front.import_second_product.ajax_blur_item', $data);
	}
	...
	public function postAddItem()
	{
		...
		return View::make('front.import_second_product.ajax_items', $data);
	}
	...
	public function getAjaxBlurUpdateItem($item_id, $branch_id)
	{
		...
		return View::make('front.import_second_product.ajax_blur_update_item', $data);
	}
	...
	public function postCreate()
	{
		...
		{
			return Redirect::to('import-second-product/create')->with('error-message', "No items you entered.")->withInput();
		}
		...
		if ($validator->passes())
		{
			DB::transaction(function() use ($setting){
				...
				$importsecondproduct = new Importsecondproduct;
				$importsecondproduct->branch_id = Auth::user()->get()->branch_id;
				$importsecondproduct->customer_id = htmlspecialchars(Input::get('customer_id'));
				$importsecondproduct->user_id = Auth::user()->get()->id;
			...
			return Redirect::to('import-second-product')->with('success-message', "Recycle Input <strong>$importsecondproduct->no_invoice</strong> has been Created.");
		}
		else
		{
			return Redirect::to('import-second-product/create')->withInput()->withErrors($validator);
		}
	}
	...
	public function getView($id)
	{
		...
		$importsecondproduct = Importsecondproduct::where('id', '=', $id)->where('branch_id', '=', Auth::user()->get()->branch_id)->first();
		if ($importsecondproduct != null)
		{
	        ...
	        return View::make('front.import_second_product.view', $data);
		}
		else
		{
			return Redirect::to('import-second-product')->with('error-message', 'Can not find any Recycle Input with ID ' . $id);
		}
	}
	...
	public function getEdit($id)
	{
		...
		if ($importsecondproduct != null)
		{
	        ...
	        return View::make('front.import_second_product.edit', $data);
		}
		else
		{
			return Redirect::to('import-second-product')->with('error-message', 'Can not find any Recycle Input with ID ' . $id);
	...
	public function putEdit($id)
	{
		...
		if(Cart::totalItems() == 0)
		{
			return Redirect::to('import-second-product/edit/' . $id)->with('error-message', "No items you entered.")->withInput();
		}
		...
		if ($validator->passes())
		{
			...
			return Redirect::to('import-second-product')->with('success-message', "Recycle Input <strong>$importsecondproduct->no_invoice</strong> has been Updated.");
		}
		else
		{
			return Redirect::to('import-second-product/edit/' . $id)->withInput()->withErrors($validator);
		}
	}
	...
	public function getDelete($id)
	{
		...
		if ($importsecondproduct != null)
		{
            ...
            {
				return Redirect::to(Crypt::decrypt($setting->admin_url) . '/import-second-product')->with('success-message', "Admin <strong>$form_no</strong> has been Deleted.");
            }
		}
		else
		{
			return Redirect::to(Crypt::decrypt($setting->admin_url) . '/import-second-product')->with('error-message', 'Can not find any admin with ID ' . $id);
		}
	}
