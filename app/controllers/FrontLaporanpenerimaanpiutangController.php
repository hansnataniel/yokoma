...
class FrontLaporanpenerimaanpiutangController extends BaseController {
	...
	public function getIndex()
	{
        ...
        return View::make('front.laporan_penerimaan_piutang.index', $data);
	}
	...
	public function getReport()
	{
        ...
        return View::make('front.laporan_penerimaan_piutang.print', $data);
	...
	public function getExcel($branch_id, $start_date, $end_date)
	{
		...
		Excel::create('Laporan penjualan (produk) ' . date('d-m-Y', strtotime($start_date)) . ' s/d ' . date('d-m-Y', strtotime($end_date)), function($excel) use($data) {
		    ...
		    $excel->sheet('Laporan penjualan', function($sheet) use($data) {
		        ...
		        $sheet->loadView('front.laporan_penerimaan_piutang.excel_print', $data);

		    });

		})->download('xls');

        // return View::make('front.laporan_penerimaan_piutang.excel_print', $data);
	...
	public function getPdf($branch_id, $start_date, $end_date)
	{
		...
		$html = \View::make('front.laporan_penerimaan_piutang.pdf_print', $data);
		$pdf = PDF::loadHTML($html);
		return $pdf->stream();
        // return View::make('front.laporan_penerimaan_piutang.pdf_print', $data);
