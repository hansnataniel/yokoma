...
class FrontPembulatanController extends BaseController {
	...
	public function getIndex()
	{
		...
		$pembulatans = $query->get();
		$data['pembulatans'] = $pembulatans;

		$sales = Sale::where('branch_id', '=', Auth::user()->get()->branch_id)->where('status', '=', 'Waiting for Payment')->get();
        ...
        return View::make('front.pembulatan.index', $data);
	}
	...
	public function getCreate()
	{
        ...
        return View::make('front.pembulatan.create', $data);
	}
	...
	public function getAjaxNota($sale_id)
	{
        ...
        return View::make('front.pembulatan.ajax_nota', $data);
	}
	...
	public function postCreate()
	{
		...
		if ($validator->passes())
		{
			...
			return Redirect::to('pembulatan-nota')->with('success-message', "Pembulatan has been Created.");
		}
		else
		{
			return Redirect::to('pembulatan-nota/create')->withInput()->withErrors($validator);
		}
	}
}
