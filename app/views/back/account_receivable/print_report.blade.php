...
<body>
	...
	<a target="_blank" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account-receivable/pdf/' . $branch->id)}}">
		{{Form::button('Print', array('class'=>'button-print print'))}}
	</a>
	<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account-receivable/excel/' . $branch->id)}}">
