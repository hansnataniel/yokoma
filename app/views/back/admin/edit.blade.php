...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Admin Edit
@stop

@section('help')
	<ul style="padding-left: 18px;">
		<li>Anda dapat merubah detail admin pada halaman ini.</li>
		...
		<li>Pilih Active pada Active Status jika admin yang anda buat mempunyai status aktif, dan sebaliknya.</li>
	</ul>
@stop

@section('content')
	{{Form::model($admin, array('url' => URL::current(), 'method' => 'PUT', 'files' => true))}}
		<section id="edit-container">
			<div class="edit-group">
				<div class="edit-left">
					{{Form::label('admingroup', 'Admin Group')}}
				</div><!--
				--><div class="edit-right">
					{{Form::select('admingroup', $admingroup_options, $admin->admingroup_id, array('class'=>'medium-text select'))}}
