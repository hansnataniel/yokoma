...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> New User Group
@stop
...
@section('help')
	<ul style="padding-left: 18px;">
		...
		<!--
		<li>Anda dapat menambahkan User Group baru pada halaman ini.</li>
...
@section('content')
	{{Form::model($admingroup, array('url' => URL::current(), 'files' => true))}}
