...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Branch Edit
@stop
...
@section('content')
	{{Form::model($branch, array('url' => URL::current(), 'method' => 'PUT', 'files' => true))}}
