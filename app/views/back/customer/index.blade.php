...
@section('search')
	{{Form::open(array('URL' => URL::current(), 'method' => 'GET'))}}
		<div class="search-group">
			...
			<div class='search-input'>
				{{Form::text('src_address', '', array('class'=>'search-text', 'placeholder'=>'Address'))}}
			</div>
			<div class='search-input'>
				{{Form::select('src_branch_id', $branch_options, null, array('class'=>'search-text select'))}}
			</div>
			<div class='search-input'>
...
@section('content')
	<section id="index-container">
		<header id="index-header">
			<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/customer/create')}}" class="index-addnew">
					...
					<td class="icon">
						<div class="index-icon">
							...
							<div class="index-sub-icon">
								<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/customer/view/' . $customer->id)}}"><div class="icon-sub">{{HTML::image('img/admin/view.png')}} <span>View</span></div></a>
								<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/customer/edit/' . $customer->id)}}"><div class="icon-sub">{{HTML::image('img/admin/edit.png')}} <span>Edit</span></div></a>
							</div>
						</div>
					</td>
				</tr>
