...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> New Klaim Item
@stop
...
@section('content')
	{{Form::model($productrepair, array('url' => URL::current(), 'files' => true))}}
