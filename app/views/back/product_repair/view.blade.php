...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Import Klaim Item View
@stop

@section('help')
	<ul style="padding-left: 18px;">
		<li>Disini anda dapat melihat data Klaim Item secara keseluruhan.</li>
...
@section('content')
	<section id="view-container">
		<div id="view-general-information">
			{{-- <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/import-second-product/edit/' . $productrepair->id)}}">{{HTML::image('img/admin/edit_view.png', '', array('id'=>'view-edit-button'))}}</a> --}}
			<div id="view-date">
