						...
						<td class="icon">
							<div class="index-icon">
								...
								<div class="index-sub-icon">
									<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/sales/view/' . $sale->id)}}" target="_blank"><div class="icon-sub">{{HTML::image('img/admin/view.png')}} <span>View Sales</span></div></a>
									<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/payment/create')}}" target="_blank"><div class="icon-sub">{{HTML::image('img/admin/check.png')}} <span>Payment</span></div></a>
								</div>
							</div>
						</td>
					</tr>
