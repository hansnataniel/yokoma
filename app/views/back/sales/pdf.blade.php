<html style="margin: 0; padding: 0;">
	...
	<body style="margin: 0; width: 210mm; height: 138mm; padding-top: 5mm; font-family: arial; font-size 14px;">
		...
		<div style="margin-left: 25px; margin-bottom: 5px; font-size: 14px; font-weight: bold;">
			Terbilang: <i>{{terbilang($sale->paid)}} rupiah</i>
		</div>

		<div style="width: 110px; display: inline-block; vertical-align: top; text-align: center; margin-left: 20px; margin-top: 25px; font-size: 14px;">
