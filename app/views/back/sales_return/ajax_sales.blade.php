...
<section class="view-data-info" style="display: inline-block; width: 49%; vertical-align: top;">
	<header class="view-data-header">
		Sales Items, <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/sales/view/' . $sale->id)}}" target="_blank"><div class="icon-sub" style="width: 95px; padding-top: 9px; display: inline-block; margin-left: 10px;">{{HTML::image('img/admin/view.png')}} <span>View Sales</span></div></a>
	</header>
