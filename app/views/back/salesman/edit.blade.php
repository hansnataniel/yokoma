...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Salesman Edit
@stop
...
@section('content')
	{{Form::model($salesman, array('url' => URL::current(), 'method' => 'PUT', 'files' => true))}}
		<section id="edit-container">
			<div class="edit-group">
				...
				--><div class="edit-right">
					{{Form::select('branch', $branch_options, $salesman->branch_id, array('class'=>'medium-text select', 'required'))}}
