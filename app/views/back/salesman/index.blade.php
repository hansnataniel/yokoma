...
@section('search')
	{{Form::open(array('URL' => URL::current(), 'method' => 'GET'))}}
		<div class="search-group">
			...
			<div class='search-input'>
				{{Form::select('src_branch', $branch_options, null, array('class'=>'search-text select'))}}
			</div>
			<div class='search-input'>
...
@section('content')
	<section id="index-container">
		<header id="index-header">
			<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/salesman/create')}}" class="index-addnew">
					...
					<td class="icon">
						<div class="index-icon">
							...
							<div class="index-sub-icon">
								<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/salesman/view/' . $salesman->id)}}"><div class="icon-sub">{{HTML::image('img/admin/view.png')}} <span>View</span></div></a>
								<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/salesman/edit/' . $salesman->id)}}"><div class="icon-sub">{{HTML::image('img/admin/edit.png')}} <span>Edit</span></div></a>
								...
								<section class="blur">
									<div class="blur-question">
										<span class="blur-text">
											Do you really want to delete this salesman?
										</span>
										<table>
											<tr>
												<td>
										...
										<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/salesman/delete/' . $salesman->id . '?_token=' . Session::token())}}">
