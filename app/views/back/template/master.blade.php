<html>
	<head>
		...
		<title>CREIDS | @yield('title')</title>
		...
		<section id="wrapper">
			...
			<section id="content-container">
				<header id="page-header">
					<div id="greetings">Hello <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/admin/edit-profile')}}"><strong>{{Auth::admin()->get()->name}}</strong></a> Welcome to CREIDS backend system  |  <span id="sign-out">{{HTML::link(URL::to(Crypt::decrypt($setting->admin_url) . '/logout'), 'Sign Out')}}</span></div>
