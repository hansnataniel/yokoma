...
@section('content')
	<section id="index-container">
		<header id="index-header">
			<a href="{{URL::to('account-receivable/print-report')}}" target="_blank" class="index-addnew">
			...
			@foreach ($customers as $customer)
				...
				@if(count($sales) != 0)
					...
					<tr class="index-tr index-title" style="background: none; height: 26px;">
						<td></td>
						<th style="background: rgb(215, 29, 33);">Sale (No. Invoice)</th>
						<th style="background: rgb(215, 29, 33);">Invoice Date</th>
						<th style="background: rgb(215, 29, 33);">Due Date</th>
						<th style="background: rgb(215, 29, 33);">Paid</th>
						<th style="background: rgb(215, 29, 33);">Owed</th>
					</tr>
