...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> New Customer
@stop
...
@section('content')
	{{Form::model($customer, array('url' => URL::current(), 'files' => true))}}
		<section id="edit-container">
			...
			<div class="edit-group">
				...
				--><div class="edit-right">
					...
					{{Form::text('commission1', 0, array('class'=>'small-text-prepend', 'placeholder'=>'Commision'))}}<!--
			...
			<div class="edit-group">
				...
				--><div class="edit-right">
					...
					{{Form::input('number', 'commission2', 0, array('class'=>'small-text-prepend', 'placeholder'=>'Commision'))}}<!--
