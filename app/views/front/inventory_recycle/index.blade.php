...
@section('title')
	Accu Mati Item Inventory Management
@stop
...
@section('help')
	<ul style="padding-left: 18px;">
		<li>Disini anda dapat melihat sekilas data dari Accu Mati Item Inventory.</li>
		<li>Gunakan tombol New untuk masuk ke halaman New Accu Mati Item Inventory.</li>
		<li>Gunakan tombol View di dalam tombol Action untuk masuk ke halaman View Accu Mati Item Inventory.</li>
		<li>Gunakan tombol Edit di dalam tombol Action untuk masuk ke halaman Edit Accu Mati Item Inventory.</li>
		<li>Gunakan tombol Delete di dalam tombol Action untuk menghapus Accu Mati Item Inventory.</li>
	</ul>
@stop
	...
	<section id="index-container">
		...
		<table id="index-table" style="border-spacing: 0px;">
			...
			@foreach ($products as $product)
				<?php 
					$counter++; 
					$inventory = Inventorysecond::where('branch_id', '=', Auth::user()->get()->branch_id)->where('product_id', '=', $product->id)->orderBy('date', 'desc')->orderBy('id', 'desc')->first();
					if($inventory != null)
					{
