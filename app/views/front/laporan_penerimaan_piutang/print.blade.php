...
<body>
	...
	<div class='content'>
		...
		<a target="_blank" href="{{URL::to('laporan-penerimaan-piutang/pdf/' . $branch->id . '/' . $start_date . '/' . $end_date)}}">
			{{Form::button('Print', array('class'=>'button-print print'))}}
		</a>
		<a href="{{URL::to('laporan-penerimaan-piutang/excel/' . $branch->id . '/' . $start_date . '/' . $end_date)}}">
