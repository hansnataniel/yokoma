...
@section('help')
	<ul style="padding-left: 18px;">
		...
		<li>Gunakan tombol Edit di dalam tombol Action untuk masuk ke halaman Edit Penerimaan Piutang.</li>
		<li>Gunakan tombol Delete di dalam tombol Action untuk menghapus Penerimaan Piutang.</li>
	</ul>
@stop
...
@section('content')
	<section id="index-container">
		<header id="index-header">
			<a href="{{URL::to('payment/create')}}" class="index-addnew">
					...
					<td class="icon">
						<div class="index-icon">
							...
							<div class="index-sub-icon">
								<a href="{{URL::to('payment/view/' . $payment->id)}}"><div class="icon-sub">{{HTML::image('img/admin/view.png')}} <span>View</span></div></a>
								<a href="{{URL::to('payment/print-invoice/' . $payment->id)}}" target="_blank"><div class="icon-sub">{{HTML::image('img/admin/printer.png')}} <span>Print Invoice</span></div></a>
								<a href="{{URL::to('payment/edit/' . $payment->id)}}"><div class="icon-sub">{{HTML::image('img/admin/edit.png')}} <span>Edit</span></div></a>
								...
								<section class="blur">
									<div class="blur-question">
										...
										<a href="{{URL::to('payment/delete/' . $payment->id)}}">
