	...
	<script>
		$(function(){
			...
			$('.branch-id').live('change', function(){
	            ...
	            $.ajax({
	                type: "GET",
	                url: "{{URL::to('product-repair/ajax-branch')}}/"+selected,
			...
			$('.ajax-product').live('change', function(){
	            ...
	            $.ajax({
	                type: "GET",
	                url: "{{URL::to('product-repair/ajax-product')}}/" + branchId + '/' + productId,
	                success: function(msg){
			...
			$('.add-item').live('click', function(){
				...
				$.ajax({
	                type: "GET",
	                url: "{{URL::to('product-repair/ajax-blur-item')}}/" + branchId,
	                success: function(msg){
			...
			$('.ajax-form-item').live('submit', function(e){
				...
				$.ajax({
					type: "POST",
					data: submitData,
					url: "{{URL::to('product-repair/add-item')}}",
					success:function(msg) {
			...
			$('.delete-item').live('click', function(){
				...
				$.ajax({
					type: "GET",
					url: "{{URL::to('product-repair/ajax-update-item')}}/" + itemId + '/' + price + '/' + qty ,
					success:function(msg) {
						$('.hasil-ajax-item').html(msg);
						$('.blur-loader').hide();
					}
			...
			$('.update-item').live('click', function(){
				...
				$.ajax({
	                type: "GET",
	                url: "{{URL::to('product-repair/ajax-blur-update-item')}}/" + itemId + '/' + branchId,
	                success: function(msg){
	                    $('#blur-ajax-item').html(msg);
						$('#blur-ajax-item').show();
	                }
...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Kalim Item Edit
@stop
