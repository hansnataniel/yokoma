{{Form::open(array('url'=>URL::to(Crypt::decrypt($setting->admin_url) . '/pembelian/ajax-update-item'), 'method'=>'POST', 'files'=>True, 'class'=>'ajax-form-update-item', 'id'=>'ajax-form-update-item'))}}
