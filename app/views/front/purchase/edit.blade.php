...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Pembelian Edit
@stop
...
@section('content')
	{{Form::model($purchase, array('url' => URL::current(), 'method' => 'PUT', 'files' => true))}}
		<section id="edit-container">
			<div class="edit-group">
				...
				--><div class="edit-right">
					{{Form::text('no_invoice', $purchase->no_invoice, array('class'=>'medium-text readonly', 'readonly'))}}
			...
			<div class="edit-group">
				...
				--><div class="edit-right">
					{{Form::text('date', $purchase->date, array('class'=>'medium-text datetimepicker', 'required', 'readonly'))}}
					<span class="required-tx">
						*Required
					</span>
				</div>
