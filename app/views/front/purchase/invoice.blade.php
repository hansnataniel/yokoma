<html style="margin: 0; padding: 0;">
	...
	<body style="margin: 0; width: 210mm; height: 148mm; border: solid 1px #000; padding: 20px 0; font-family: arial; font-size 14px;">
		...
		<div style="display: inline-block; vertical-align: top; text-align: center; margin-left: 20px; margin-top: 25px; font-seze: 14px;">
		...
		<a href="{{URL::to('pembelian/pdf/' . $purchase->id)}}" target="_blank">
