...
@section('page_title')
	<a href="{{URL::to(Session::get('last_url'))}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Status Perubahan Nota
@stop
...
@section('content')
	{{Form::model($sale, array('url' => URL::to('request-update-sales/edit/' . $sale->id), 'method' => 'PUT', 'files' => true))}}
