	...
	<script>
		$(function(){
			...
			$('.branch-id').live('change', function(){
				$('.blur-loader').show();
				var selected = "{{$sale->branch_id}}";


	            $.ajax({
	                type: "GET",
	                url: "{{URL::to('sales/ajax-branch')}}/"+selected,
			...
			$('.add-item').live('click', function(){
				...
				$.ajax({
	                type: "GET",
	                url: "{{URL::to('sales/ajax-blur-item')}}/" + branchId,
	                success: function(msg){
			...
			$('.delete-item').live('click', function(){
				...
				$.ajax({
					type: "GET",
					url: "{{URL::to('sales/ajax-update-item')}}/" + itemId + '/' + price + '/' + qty ,
					success:function(msg) {
						$('.hasil-ajax-item').html(msg);
						$('.blur-loader').hide();
					}
			...
			$('.update-item').live('click', function(){
				...
				$.ajax({
	                type: "GET",
	                url: "{{URL::to('sales/ajax-blur-update-item')}}/" + itemId + '/' + branchId,
	                success: function(msg){
	                    $('#blur-ajax-item').html(msg);
						$('#blur-ajax-item').show();
	                }
