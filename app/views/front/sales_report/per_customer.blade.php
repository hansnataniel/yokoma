...
<body>
	...
	<div class='content'>
		...
		<a target="_blank" href="{{URL::to('sales-report/pdf/' . $branch->id . '/' . $start_date . '/' . $end_date . '/per-customer')}}">
			{{Form::button('Print', array('class'=>'button-print print'))}}
		</a>
		<a href="{{URL::to('sales-report/excel/' . $branch->id . '/' . $start_date . '/' . $end_date . '/per-customer')}}">
