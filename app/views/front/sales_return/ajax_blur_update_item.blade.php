{{Form::open(array('url'=>URL::to(Crypt::decrypt($setting->admin_url) . '/sales/ajax-update-item'), 'method'=>'GET', 'files'=>True, 'class'=>'ajax-form-update-item'))}}
	<div id="blur-ajax-question">
		...
		<div class="edit-group">
			...
			--><div class="edit-right">
				{{Form::input('number', 'price', $item->price, array('class'=>'small-text update-price readonly', 'Readonly'))}}
				<span class="required-tx">
					*Readonly
				</span>
			</div>
		...
		<div class="edit-group">
			...
			--><div class="edit-right">
				{{Form::input('number', 'qty', $item->quantity, array('class'=>'small-text update-qty', 'required', 'max'=>$stock, 'min'=>1))}}
				<span class="required-tx">
