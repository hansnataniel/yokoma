	...
	<script>
		$(function(){
			...
			$('.branch-id').live('change', function(){
	            ...
	            $.ajax({
	                type: "GET",
	                url: "{{URL::to('sales-return/ajax-branch')}}/"+selected,
			...
			$('.ajax-sales').live('change', function(){
		        ...
		        $.ajax({
		            type: "GET",
		            url: "{{URL::to('sales-return/ajax-sales')}}/" + salesId,
		            success: function(msg){
			...
			$('.ajax-product').live('change', function(){
	            ...
	            $.ajax({
	                type: "GET",
	                url: "{{URL::to('sales-return/ajax-product')}}/" + branchId + '/' + productId,
	                success: function(msg){
			...
			$('.add-item').live('click', function(){
				...
				$.ajax({
	                type: "GET",
	                url: "{{URL::to('sales-return/ajax-blur-item')}}/" + dataId,
	                success: function(msg){
			...
			$('.ajax-form-item').live('submit', function(e){
				...
				$.ajax({
					type: "POST",
					data: submitData,
					url: "{{URL::to('sales-return/add-item')}}",
					success:function(msg) {
			...
			$('.delete-item').live('click', function(){
				...
				$.ajax({
					type: "GET",
					url: "{{URL::to('sales-return/ajax-update-item')}}/" + itemId + '/' + price + '/' + qty ,
					success:function(msg) {
						$('.hasil-ajax-item').html(msg);
						$('.blur-loader').hide();
					}
			...
			$('.update-item').live('click', function(){
				...
				$.ajax({
	                type: "GET",
	                url: "{{URL::to('sales-return/ajax-blur-update-item')}}/" + itemId + '/' + branchId,
	                success: function(msg){
	                    $('#blur-ajax-item').html(msg);
						$('#blur-ajax-item').show();
	                }
