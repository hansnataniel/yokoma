...
@section('content')
	<section id="index-container">
		<header id="index-header">
			<a href="{{URL::to('sales-return/create')}}" class="index-addnew">
					...
					<td class="icon">
						<div class="index-icon">
							...
							<div class="index-sub-icon">
								<a href="{{URL::to('sales-return/view/' . $salesreturn->id)}}"><div class="icon-sub">{{HTML::image('img/admin/view.png')}} <span>View</span></div></a>
								<a href="{{URL::to('sales-return/print-invoice/' . $salesreturn->id)}}" target="_blank"><div class="icon-sub">{{HTML::image('img/admin/printer.png')}} <span>Print Invoice</span></div></a>
								{{-- <a href="{{URL::to('sales-return/edit/' . $salesreturn->id)}}"><div class="icon-sub">{{HTML::image('img/admin/edit.png')}} <span>Edit</span></div></a> --}}
							</div>
						</div>
					</td>
				</tr>
