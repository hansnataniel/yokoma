...
@section('page_title')
	<a href="{{URL::to('dashboard')}}">{{HTML::image('img/admin/back.png', '', array('class'=>'image-img'))}}</a> Edit Profile
@stop

@section('help')
	<ul style="padding-left: 18px;">
		<li>Anda dapat merubah profile Anda pada halaman ini.</li>
...
@section('content')
	{{Form::model($user, array('url' => URL::current(), 'files' => true))}}
